                    ...
                    <div className="space-y-6">
                        ...
                        <div className="bg-gradient-to-br from-teal-600 to-cyan-600 rounded-2xl p-6 text-white shadow-xl">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-teal-100">v2.0 (DenseNet+YOLO) — Ready</p>
                                </div>
                            </div>
                            <p className="text-sm text-teal-100 mb-3">
                                Dual-model architecture: DenseNet-121 for whole-image classification and YOLOv9 for region-level localization with AI-generated heatmaps.
                            </p>
                            <div className="flex items-center gap-2 text-xs text-teal-200 bg-white/10 rounded-lg px-3 py-2">
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                                </svg>
                                Powered by Gemini AI for clinical recommendations
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
                            ...
                            <div className="space-y-3">
                                {[
                                    { name: 'Disc Space Narrowing', color: 'bg-orange-500' },
                                    { name: 'Osteophytes', color: 'bg-red-500' },
                                    { name: 'Surgical Implant', color: 'bg-blue-500' },
                                    { name: 'Normal (No Finding)', color: 'bg-emerald-500' },
                                ].map((condition) => (
                                    <div key={condition.name} className="flex items-center gap-3 text-sm">
                                        <div className={`w-2.5 h-2.5 ${condition.color} rounded-full`}></div>
